                ...
                request(
                  {
                    ...
                    json: {
                      ...
                      PhoneNumber: phone,
                      CallBackURL:
                        "https://a77d-41-191-227-165.ngrok-free.app/api/stkPushCallback/".concat(
                          Order_ID
                        ),
          ...
          while (1)
            switch ((_context2.prev = _context2.next)) {
              case 0:
                ...
                (_req$body$Body$stkCal = req.body.Body.stkCallback),
                  (MerchantRequestID = _req$body$Body$stkCal.MerchantRequestID),
                  (CheckoutRequestID = _req$body$Body$stkCal.CheckoutRequestID),
                  (ResultCode = _req$body$Body$stkCal.ResultCode),
                  (ResultDesc = _req$body$Body$stkCal.ResultDesc),
                  (CallbackMetadata = _req$body$Body$stkCal.CallbackMetadata); //     get the meta data from the meta
                _context2.t0 = Object;
                _context2.next = 6;
