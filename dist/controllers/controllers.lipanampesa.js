...
exports.stkPushCallback = exports.initiateSTKPush = exports.confirmPayment = void 0;
var _request = _interopRequireDefault(require("request"));
require("dotenv/config");
var _utilsTimestamp = require("../Utils/utils.timestamp.js");
...
// @route /stkPush
// @access public
var initiateSTKPush = exports.initiateSTKPush = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, amount, phone, Order_ID, url, auth, timestamp, password, callback_url, api;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          timestamp = (0, _utilsTimestamp.getTimestamp)(); //shortcode + passkey + timestamp
          password = new Buffer.from(process.env.BUSINESS_SHORT_CODE + process.env.PASS_KEY + timestamp).toString("base64"); // create callback url
          _context.next = 8;
          return _ngrok["default"].connect(process.env.PORT);
        case 8:
          callback_url = _context.sent;
          api = _ngrok["default"].getApi();
          _context.next = 12;
        ...
        case 12:
          ...
          (0, _request["default"])({
            ...
            json: {
              ...
              PhoneNumber: phone,
              CallBackURL: "".concat(callback_url, "/api/stkPushCallback/").concat(Order_ID),
        ...
        case 16:
          ...
          console.error("Error while trying to create LipaNaMpesa details", _context.t0);
          res.status(503).send({
...
// @access public
var stkPushCallback = exports.stkPushCallback = /*#__PURE__*/function () {
...
// @access public
var confirmPayment = exports.confirmPayment = /*#__PURE__*/function () {
